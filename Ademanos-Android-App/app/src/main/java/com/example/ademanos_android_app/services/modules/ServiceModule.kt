...
import com.example.ademanos_android_app.services.impl.TrackingServiceImpl
import dagger.Binds
...
abstract class ServiceModule {
    ...
    @Binds abstract fun providesTrackingService(impl: TrackingServiceImpl): TrackingService
}